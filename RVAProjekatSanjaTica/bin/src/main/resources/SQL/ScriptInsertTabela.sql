...
insert into smer(id,naziv,oznaka)values(-100,'test naziv','test oznaka');
insert into projekat(id,naziv,oznaka,opis) values (-100,'test naziv proj','test oznaka proj','test opis projekta');
insert into grupa(id,oznaka,smer) values (-100,'6',7);
insert into student(id,ime,prezime,broj_indeksa,grupa,projekat) values(-100,'test ime','test prezime','test br indeksa',4,5);
